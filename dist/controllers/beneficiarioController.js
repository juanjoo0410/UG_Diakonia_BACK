...
exports.deleteBeneficiario = exports.updateBeneficiario = exports.getBeneficiarioById = exports.getTotalBeneficiariosByInstituciones = exports.getTotalBeneficiarios = exports.getBeneficiarios = exports.createBeneficiario = void 0;
...
const getTotalBeneficiarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const totalBeneficiarios = yield beneficiarioModel_1.Beneficiario.count({
            where: {
                estado: true,
            },
        });
...
exports.getTotalBeneficiarios = getTotalBeneficiarios;
const getTotalBeneficiariosByInstituciones = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const totalBeneficiarios = yield beneficiarioModel_1.Beneficiario.findAll({
            where: {
                estado: true,
            },
...
exports.getTotalBeneficiariosByInstituciones = getTotalBeneficiariosByInstituciones;
